...
namespace WebApi.DBManager
{
    public class Dapperr : IDapper
    {
        ...
        public Dapperr(IConfiguration configuration)
        {
            ...
            // Connectionstring = "Data Source=DESKTOP-7765167;Initial Catalog=Tools_DB;Integrated Security=True;"; 
             Connectionstring = "workstation id=Tools_Db.mssql.somee.com;packet size=4096;user id=Hasnain_SQLLogin_1;pwd=P@ssw0rd2024;data source=Tools_Db.mssql.somee.com;persist security info=False;initial catalog=Tools_Db"; 

            //configuration.GetConnectionString("dbconnection");//  ConfigurationManager.ConnectionStrings["dbconnection"].ConnectionString;
        }
        public void Dispose()
        {
